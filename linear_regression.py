...
def main():
    ...
    while not choice_is_valid:
        ...
        if predict_or_test == '1':
            ...
            predict_file = 'predict/2021predictR1.txt'
            # predict_file = 'predict/2021predictR2.txt'
            # predict_file = 'predict/2021predictS16.txt'
            # predict_file = 'predict/2021predictE8.txt'
            # predict_file = 'predict/2021predictF4.txt'
